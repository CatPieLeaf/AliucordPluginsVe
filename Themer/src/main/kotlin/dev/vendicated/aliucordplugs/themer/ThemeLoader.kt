...
class Themer : Plugin() {
    ...
    override fun start(ctx: Context) {
        ...
        subscription = StoreStream.getUserSettingsSystem()
            .observeSettings(false)
            .subscribe {
                val newTheme = StoreStream.getUserSettingsSystem().theme
        ...
        patcher.patch(
            com.aliucord.Main::class.java.getDeclaredMethod("crashHandler", Thread::class.java, Throwable::class.java),
            PreHook {
                // Ignore exceptions not from main thread
